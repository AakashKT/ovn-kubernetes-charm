...
def install_k8s_master():
    ...
    #
    os.system("ovs-vsctl set Open_vSwitch . external_ids:k8s-api-server='127.0.0.1:8080'");
    ...
    os.system("ovn-k8s-overlay master-init --cluster-ip-subnet='192.168.0.0/16' --master-switch-subnet='192.168.1.0/24' --node-name='kube-master' ")
